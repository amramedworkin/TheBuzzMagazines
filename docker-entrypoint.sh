...
$sugar_config['dbconfig']['db_host_name'] = getenv('SUITECRM_RUNTIME_MYSQL_HOST') ?: 'localhost';
$sugar_config['dbconfig']['db_port'] = getenv('SUITECRM_RUNTIME_MYSQL_PORT') ?: '3306';
$sugar_config['dbconfig']['db_user_name'] = getenv('SUITECRM_RUNTIME_MYSQL_USER') ?: 'suitecrm';
$sugar_config['dbconfig']['db_password'] = getenv('SUITECRM_RUNTIME_MYSQL_PASSWORD') ?: '';
$sugar_config['dbconfig']['db_name'] = getenv('SUITECRM_RUNTIME_MYSQL_NAME') ?: 'suitecrm';
$sugar_config['dbconfig']['db_type'] = 'mysql';
$sugar_config['dbconfig']['db_manager'] = 'MysqliManager';

// Azure MySQL requires SSL
$sugar_config['dbconfig']['db_ssl_enabled'] = filter_var(getenv('SUITECRM_RUNTIME_MYSQL_SSL_ENABLED') ?: 'true', FILTER_VALIDATE_BOOLEAN);
$sugar_config['dbconfig']['db_ssl_ca'] = getenv('SUITECRM_RUNTIME_MYSQL_SSL_CA') ?: '/etc/ssl/certs/ca-certificates.crt';
$sugar_config['dbconfig']['db_ssl_verify'] = filter_var(getenv('SUITECRM_RUNTIME_MYSQL_SSL_VERIFY') ?: 'true', FILTER_VALIDATE_BOOLEAN);
